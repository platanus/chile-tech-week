...
RSpec.describe "admin emails" do
  ...
  describe "GET /admin/:week/emails" do
  ...
  describe "POST /admin/:week/emails/:id/resend" do
    it "resends the stored message" do
      ...
      expect(response).to redirect_to("/admin/25/emails/#{email.id}")
      follow_redirect!
